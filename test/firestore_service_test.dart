...
void main() {
  group('Firestore Models & Serialization Tests', () {
    test(
      'FoodItemModel toFirestore serialization retains core nutrition fields',
      () {
    ...
    test(
      'PantryItemModel toFirestore serialization formats date and booleans accurately',
      () {
    ...
    test(
      'FoodLogModel toFirestore serialization handles macronutrients and note',
      () {
    ...
    test(
      'UserModelSQL toFirestore serialization handles Firebase UID and eco points',
      () {
    ...
    test(
      'FirestoreService singleton instance initializes gracefully in test environment',
      () {
