              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: IconButton(
                        ...
                        icon: const Icon(Icons.arrow_back_ios_new_rounded,
                            size: 20, color: AppColors.textGraySoft),
                      ),
                    ),
                    ...
                    Center(
                      child: Container(
                        ...
                        child: const Icon(Icons.lock_outline_rounded,
                            size: 32, color: Color(0xFF1B4D2E)),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: AppTextStyles.body
                            .copyWith(color: AppColors.textGraySoft, fontSize: 14),
                      ),
                    ),
                    const SizedBox(height: 24),
                    ...
                    Text('Email terdaftar', style: AppTextStyles.label),
                    const SizedBox(height: 8),
                    AppTextField(
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 12),
                          child: Text('Atau kembali ke halaman login',
                              style: AppTextStyles.subtitleSmall
                                  .copyWith(fontSize: 11)),
                        ),
                        Expanded(child: Divider(color: Colors.grey.shade300)),
